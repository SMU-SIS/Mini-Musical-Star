...
#import "MusicalStarAppDelegate.h"

@implementation MusicalStarAppDelegate
...
//    Cue *cue = [picture.cueList objectAtIndex:0];
//    NSLog(@"%@ %@",picture.title,cue.);
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MusicalStar" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MusicalStar.sqlite"];
